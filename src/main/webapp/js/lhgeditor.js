...
J.exend({
	editor : {
		...
		tool : [
		    { txt: 'bold', pos: '0 0', tit: 'Bold' },
			{ txt: 'italic', pos: '-16px 0', tit: 'italic' },
			{ txt: 'underline', pos: '-32px 0', tit: 'Underline' },
			{ txt: '-' },
			{ txt: 'font', pos: '-48px 0', tit: 'font' },
			{ txt: 'fsize', pos: '-64px 0', tit: 'fsize' },
			{ txt: 'serial', pos: '-80px 0', tit: 'serial' },
			{ txt: 'align', pos: '-96px 0', tit: 'align' },
			{ txt: 'indent', pos: '-112px 0', tit: 'indent' },
			{ txt: '-' },
			{ txt: 'fcolor', pos: '-128px 0', tit: 'fcolor' },
			{ txt: 'bcolor', pos: '-144px 0', tit: 'bcolor' },
			{ txt: 'image', pos: '-160px 0', tit: 'image' },
			{ txt: 'link', pos: '-176px 0', tit: 'link' },
			{ txt: '-' },
			{ txt: 'code', pos: '-208px 0', tit: 'code' }
		], ed : {}, win : [], oid : [],
		i8 : (navigator.userAgent.toLowerCase().match(/msie (\d+)/)||[])[1] == 8 && !/opera/.test(navigator.userAgent.toLowerCase()),
		font : ['Arial','Arial Narrow','Arial Black','Comic Sans MS','Courier','System','Times New Roman','Verdana'],
		fsize : ['smaller','larger','xx-small','x-small','small','medium','large'],
		serial : [{ cmd: 'insertorderedlist', txt: 'Digital number' }, { cmd: 'insertunorderedlist', txt: 'Item Number' }],
		align : [{ cmd: 'justifyleft', txt: 'align left' }, { cmd: 'justifycenter', txt: 'align center' }, { cmd: 'justifyright', txt: 'align right' }],
		indent : [{ cmd: 'indent', txt: 'indent right' }, { cmd: 'outdent', txt: 'indent left' }],
	...
	showp : function(t,id)
	{
		...
		switch(t)
		{
			...
			case 'image':
				...
				J(this.td).html( '<div class="sc_item"><span>image address：</span><input id="url" type="text" value="http://" style="font:12px Arial;width:' + w + ';"/></div>' +
				                 '<div class="sc_item"><span>description：</span><input id="alt" type="text" style="font:12px Arial;width:' + dw + ';"/>&nbsp;' +
								 '<input id="okbtn" type="button" style="font:12px Tahoma;border:1px solid #808080;" value="determine"/></div>' );
			...
			case 'link':
				...
				J(this.td).html( '<div class="sc_item"><span>link address：</span><input id="href" type="text" value="http://" style="font:12px Arial;width:' + w + ';"/>' +
				                 '&nbsp;<input id="lnbtn" type="button" style="font:12px Tahoma;border:1px solid #808080;" value="determine"/></div>' );
